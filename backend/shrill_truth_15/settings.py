"""
Django settings for shrill_truth_15 project.
...
ROOT_URLCONF = 'shrill_truth_15.urls'
...
WSGI_APPLICATION = 'shrill_truth_15.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_truth_15 API",
    "DESCRIPTION": "API documentation for shrill_truth_15 App",
    "VERSION": "v1",
}
